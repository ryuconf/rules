...
function getIsProxyFromIP(strIp) {
...
function FindProxyForURL(url, host) {
  ...
  if(check_ipv4(host) === true && getIsProxyFromIP(host) === false) {
    return direct;
  }
...
console.log(1, FindProxyForURL('https://www.amazon.co.jp/s/ref=nb_sb_noss', 'www.amazon.co.jp'))
console.log(2, FindProxyForURL('http://translate.google.cn', 'translate.google.cn'))
console.log(3, FindProxyForURL('https://www.amazon.jp/s/ref=nb_sb_noss', 'www.amazon.jp'))
console.log(4, FindProxyForURL('https://www.amazon.jp.com/s/ref=nb_sb_noss', 'www.amazon.jp.com'))
console.log(5, FindProxyForURL('http://www.163.cn', 'www.163.cn'))
console.log(6, FindProxyForURL('http://www.qq.com', 'www.qq.com'))
console.log(7, FindProxyForURL('http://qq.com', 'qq.com'))
console.log(8, FindProxyForURL('http://jp.abc.com', 'jp.abc.com'))
console.log(9, FindProxyForURL('http://abc.com', 'abc.com'))
console.log(10, FindProxyForURL('http://aaabc.com', 'aaabc.com'))
console.log(11, FindProxyForURL('http://ryu.tw', 'ryu.tw'))
console.log(12, FindProxyForURL('http://ryu.ng', 'ryu.ng'))
console.log(13, FindProxyForURL('http://ryuabc.ng', 'ryuabc.ng'))
